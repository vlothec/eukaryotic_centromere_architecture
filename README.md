...
This repository contains a subset of the scripts and analysis pipelines used to generate the manuscript "An atlas of eukaryotic centromere architecture reveals recurrent evolutionary dynamics". 

CAP pipeline is available at https://github.com/vlothec/CAP. CAP analysis provides source files for the satellite and transposon analyses 
